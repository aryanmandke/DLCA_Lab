...
<body>
    ...
    <div>
        <script>
            ...
            function gatesdisplay2(A,B,C,Output,g1,g2){

                sim.innerHTML = `<table id="tab">
                <tr>
                    <th><p id="A1" style="margin-top: 65px;">${A}</p></th>
                    <th rowspan="3"><img id ="img1" src ="../images/${g1}.png" height="150px" width="250px" style="margin-right: -20px;"></th>
                    <th style="-ms-user-select: none;user-select: none;color: white;">1</th>
                    <th rowspan="3"><img id="img2" src ="../images/${g2}.png" height="150px" width="250px" style="padding-top: 65px"  ></th>
            ...
            check.addEventListener('click', () => {
                ...
                if(gate_2 == '-'){
                    ...
                    if(gate_2 == 'NOT Gate'){
                            ...
                            gatesdisplay2(inputValA,inputValB,inputValC,output,fgate,sgate);
                            confirminsert(inputA,inputB,inputC,gate_1,gate_2,output);
                    }
                    else{
                            output = gate3(gate_1,gate_2,inputValA,inputValB,inputValC);
