...
var result;
var count = [];
var questionOption=["What is the value of <b>AC</b> next step to be taken in the below given Non-Restoring Division Algorithm?",
"What is the value of <b>Q</b> next step to be taken in the below given Non-Restoring Division Algorithm?",
"What is next step to be taken in the below given Non-Restoring Division Algorithm?"];
...
function pool(r,c){
    ...
    case 2: for(let i=0;i<r.length-1;i++){
                p[i] = ["Q[0] = 0","Left Arithmetic Shift","Q[0] = 1","A = A - M"];
            }
            break;
    }
    console.log(p);
...
function createOption(r,c,cnt){
    ...
    switch(i){
        ...
        i=Math.floor(Math.random()*6);
        switch(i){
        case 0: ans=["Q[0] = 0","Left Arithmetic Shift","Q[0] = 1","A = A - M"];break;
        case 1: ans=["A = A - M","Q[0] = 0","Left Arithmetic Shift","Q[0] = 1"];break;
        case 2: ans=["Q[0] = 0","Q[0] = 1","A = A - M","Left Arithmetic Shift"];break;
        case 3: ans=["Q[0] = 1","Left Arithmetic Shift","A = A - M","Q[0] = 0"];break;
        case 4: ans=["Left Arithmetic Shift","Q[0] = 1","Q[0] = 0","A = A - M"];break;
        case 5: ans=["Q[0] = 0","Q[0] = 1","Left Arithmetic Shift","A = A - M"];break;
        }
    }
...
function createquestion(){
    ...
    var index=0;
            while(i<3){
                var list = random();
            var result = nonrestoring(list[0],list[1]);
