...
<head>
    <meta charset="UTF-8">
    <title>Non-Restoring Division Algorithm Quiz</title>
    <style>
        body {
...
<body>
    <header>
        <a href="NonRestoTheo.php" class="back-button">Back</a>
    ...
    <main><br><br><br>
        <div class="quiz-container">
            ...
            <h2>Non-Restoring Division Algorithm Quiz</h2>
            <ol>
                <li>
                    <p>What is the primary purpose of the Non-Restoring Division Algorithm demonstrated in the virtual lab?</p>
                ...
                <li>
                    <p>In the provided truth table for the Non-Restoring Division Algorithm, what does the column "Action" represent?</p>
                ...
                <li>
                    <p>What is the primary function of the "Left Shift" operation in the Non-Restoring Division Algorithm?</p>
                ...
                <li>
                    <p>When does the Non-Restoring Division Algorithm adjust the quotient by adding the divisor?</p>
                    <input type="radio" name="q4" value="a"> Always during each iteration<br>
                    <input type="radio" name="q4" value="b"> When the accumulator (A) is greater than or equal to the divisor (M)<br>
                    <input type="radio" name="q4" value="c"> When the accumulator (A) is less than the divisor (M)<br>
                    <input type="radio" name="q4" value="d"> Only at the beginning of the algorithm<br>
                    <p class="feedback"></p>
                </li><br>
                <li>
                    <p>What is the significance of the "Count" column in the truth table of the Non-Restoring Division Algorithm?</p>
            ...
            <p class="score"></p>
            <a href="nonrestfeed.php"><button class="feed-button">Submit Feedback</button></a>
        </div>
    </main>
