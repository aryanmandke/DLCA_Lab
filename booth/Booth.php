...
function find_state(cnt){
    ...
    switch(a){
        ...
        case "Direct Right Arithmetic Shift":p.innerHTML = `${opt[4]}`; break;
    }
}
...
"We now perform Right Arithmetic Shift on <b>A</b>, <b>Q</b> and <b>Q<sub>-1</sub></b>. Additionally we decreement the <b>Count</b> by 1.",
"As both Q<sub>0</sub> and Q<sub>-1</sub> are the same, we perform Right Arithmetic Shift on <b>A</b>, <b>Q</b> and <b>Q<sub>-1</sub></b>. Additionally we decreement the <b>Count</b> by 1."];
...
next.addEventListener('click', async () => {
    ...
    if(cnt>=result.length-2){
        ...
        re.innerHTML = `<p> M = (${M})<sub>10</sub> = (${result[0].m})<sub>2</sub><br>
                ...
                Result = (${M*Q})<sub>10</sub> = (${result[result.length-1].r})<sub>2</sub>`;
    }
